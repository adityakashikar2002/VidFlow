...
const Sidebar = ({ sidebarOpen }) => {
  ...
  return (
    <motion.aside
      ...
      className={`fixed h-full bg-gradient-to-b from-indigo-50 to-purple-50 dark:from-gray-800 dark:to-gray-900 shadow-lg z-40 overflow-hidden flex-shrink-0 flex flex-col`}
    >
